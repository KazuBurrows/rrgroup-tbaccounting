...
function Brands() {
  return (
    <div className="md:w-2/3 md:flex block py-12 gap-8 justify-center items-center mx-auto">
        <img className="lg:h-32 md:h-24 h-28 mx-auto" src={crystal} alt="crystal-logo" />
        <img className="lg:h-32 md:h-24 h-28 mx-auto" src={xero} alt="xero-logo" />
        <img className="lg:h-32 md:h-24 h-28 mx-auto" src={cash} alt="cash-manager-logo" />
    </div>
